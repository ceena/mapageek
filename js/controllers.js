...
$scope.xBoundary = {start:0,end:100};
$scope.yBoundary = {start:0,end:100};
...
//create a geek
  $scope.geeks.push({id:geekId, color:geekColor,tech:$scope.geekTech, x:geekX,y:geekY});
...
$scope.startSimulation = function(){
  ...
  $scope.randomizeGeeks = function(){
    var xStepBoundary = {start:0,end:$scope.stepSize};
    var yStepBoundary = {start:0,end:$scope.stepSize};
